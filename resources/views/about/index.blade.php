                            ...
                            <div class="content-box">
                                <div class="inner-box">
                                    <div class="title-box">
                                        ...
                                        <p>...to be the best forward-thinking provider of property rental services. We want to give every one of our property owners and guests the best possible level of service at all times.</p>
                                    </div>
                    ...
                    <li data-description="Slide Description" data-easein="default" data-easeout="default" data-fsmasterspeed="1500" data-fsslotamount="7" data-fstransition="fade" data-hideafterloop="0" data-hideslideonmobile="off" data-index="rs-1689" data-masterspeed="default" data-param1="" data-param10="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-rotate="0" data-saveperformance="off" data-slotamount="default" data-thumb="images/main-slider/image-2.jpg" data-title="Slide Title" data-transition="parallaxvertical">
                        ...
                        data-frames='[{"delay":1500,"speed":1000,"frame":"0","from":"x:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"x:50px;opacity:0;","ease":"Power3.easeInOut"}]'>
                            <div class="content-box">
                                <div class="inner-box">
                                    <div class="title-box">
                                        <h3>One-stop property rental service</h3>
                                        <p>We offer a unique ‘one-stop’ property rental service and pride ourselves on being a company you can count on. </p>
                                    </div>
                                    <div class="btn-box"><a href="agent-detail.html" class="theme-btn btn-style-one">CONTACT AGENT</a></div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="info-column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="title">Our team’s experience in property rentals will ensure you receive the best service</span>
                            <h2>Global and local experience</h2>
                        </div>
                        <div class="text">
                        We combine global experience with rich local knowledge and highly accurate research to identify the best opportunities for our customers and maximise returns. From meet and greets to personal guest interaction you are assured of a comprehensive, end-to-end service when you book one of our apartment rentals. 
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="info-column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="text">
                        Our focus is not just to create a good experience for our customers, but an outstanding personal experience for guests, maximizing service and product offerings to build long lasting relationships.
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="info-column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="title"></span>
                            <h2>Quick to respond</h2>
                        </div>
                        <div class="text">
                        The number one thing customers want from customer service is faster response times. We always aim to respond to all enquiries within 2 hours maximum; this is way above the industry standard.
                        </div>
                    </div>
                </div>
                <!-- Video Column -->
