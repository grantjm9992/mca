...
<html lang="en">
    ...
    <body style="background: url(images/main-slider/beachbanner.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;    height: 100vh;">
